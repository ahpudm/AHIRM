...
with open(r'C:\Users\86138\Desktop\PinSAGE_lastfm_top_4\0.09\PinSAGE_lastfm_top_4_0.09.txt', 'r') as f:
    data = []
    data_n = []
    for line in f:
        a = line.split()
...
# save_softmax()
# save_sigmoid()
save_kg(r'C:\Users\86138\Desktop\PinSAGE_lastfm_top_4\0.09\lastfm_trusts_kg.txt')
save_n(r'C:\Users\86138\Desktop\PinSAGE_lastfm_top_4\0.09\lastfm_trusts_n.txt')
