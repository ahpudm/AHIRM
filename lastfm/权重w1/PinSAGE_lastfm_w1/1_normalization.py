...
with open(r'C:\Users\86138\Desktop\PinSAGE_lastfm_w1\bine\lastfm_w_0.5_top4.txt', 'r') as f:
    data = []
    data_n = []
    for line in f:
        a = line.split()
...
# save_softmax()
# save_sigmoid()
save_kg(r'C:\Users\86138\Desktop\PinSAGE_lastfm_w1\bine\lastfm_trusts_kg.txt')
save_n(r'C:\Users\86138\Desktop\PinSAGE_lastfm_w1\bine\lastfm_trusts_n.txt')
