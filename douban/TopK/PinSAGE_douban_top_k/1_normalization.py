...
with open(r'C:\Users\86138\Desktop\PinSAGE_douban_top_k\k10\PinSAGE_douban_top_10.txt', 'r') as f:
    data = []
    data_n = []
    for line in f:
        a = line.split()
...
# save_softmax()
# save_sigmoid()
save_kg(r'C:\Users\86138\Desktop\PinSAGE_douban_top_k\k10\douban_trusts_kg.txt')
save_n(r'C:\Users\86138\Desktop\PinSAGE_douban_top_k\k10\douban_trusts_n.txt')
